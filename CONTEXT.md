...
First name / Last name: Letters only (including accented characters: á, é, í, ó, ú, ñ, ü). No numbers or special characters.
Date of birth: Cannot be a future date. Patient must be between 0 and 120 years old.
Phone: Must start with + followed by a country code. Accept formats like +1 305 555 0191 or +34 612 345 678.
Preferred date: At least 1 business day from today. No more than 60 days in the future.
Service type + date of birth (Paediatric Care): If the patient selects "Paediatric Care", their date of birth must indicate they are under 18. If not, show a specific error.
Preferred time + clinic hours: If the patient selects "Evening (5pm–8pm)", only clinics open past 5pm are valid. Display a warning if the combination is unlikely to be available (e.g., San Antonio closes at 6pm, Austin North at 7pm).
Insurance fields: If has_insurance = Yes, both insurance_provider and insurance_member_id become required and must be validated.
Returning patient: If new_patient = No, display an additional optional field: Patient ID (name="patient_id", format HC- followed by 6 alphanumeric characters, e.g., HC-A3F291).
Health concern: Minimum 20 characters. Maximum 500. Show a live character counter.
Consent checkbox: Must be checked to submit. If unchecked, the form does not submit.
